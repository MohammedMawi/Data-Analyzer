...
def get_data():
    ...
    return jsonify({
        ...
        "rows": clean_df.head(100).to_dict(orient="records") # Convert the dataframe to a list of dictionaries, where orient="records" uses column names as keys for each row. 
    })
